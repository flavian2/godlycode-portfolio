...
import historyBnk from '../assets/banking/historybnk.png';
...
import gpsMap from '../assets/courier/gps-map.png';
import mapGps from '../assets/courier/map-gps.png';
...
export const projects = [
  {
    ...
    screenshots: [
      ...
      { src: dashboard2, caption: "Dashboard Details" },
      { src: historyBnk, caption: "Transaction History" },
      { src: transaction, caption: "Transaction Page" },
      { src: adminLogin, caption: "Admin Login" },
      { src: adminDashboard, caption: "Admin Dashboard" },
    ],
    color: "#D4AF37" // Gold
  },
  {
    ...
    shortDescription:
      "A comprehensive logistics management system with real-time GPS tracking, automated courier dispatch, and delivery analytics.",
    category: "Logistics",
    tags: [
      "PHP",
      "JavaScript",
    ...
    status: "live",
    description:
      "A comprehensive logistics management system with real-time GPS tracking, automated courier dispatch, route optimization, and delivery analytics. Built to handle the complexity of real-world delivery operations — from package pickup to final delivery confirmation.",
    keyFeatures: [
    ...
    screenshots: [
      ...
      { src: gpsDetails, caption: "GPS Details" },
      { src: gpsMap, caption: "GPS Map View" },
      { src: mapGps, caption: "Map GPS" },
      { src: courierDashboard, caption: "Admin Dashboard" },
      { src: courierDashboard2, caption: "Admin Dashboard 2" },
      { src: courierInterface, caption: "Courier Interface" },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "A full-featured educational institution management platform handling everything from student enrollment to graduation.",
    category: "Education",
    ...
    status: "live",
    description:
      "A full-featured educational institution management platform handling everything from student enrollment to graduation. Designed for schools and institutions that need a centralized system to manage students, teachers, courses, grades, and administrative operations.",
    keyFeatures: [
  ...
  },
  {
    ...
    shortDescription:
      "An intelligent trading platform that leverages Claude AI for market analysis, pattern recognition, and automated trade execution.",
    category: "AI/Trading",
    ...
    description:
      "An intelligent trading platform that leverages Claude AI for market analysis, pattern recognition, and automated trade execution. Features real-time price feeds, portfolio management, risk assessment, and historical backtesting — all powered by AI to give traders a strategic edge.",
    keyFeatures: [
